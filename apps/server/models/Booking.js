...
const bookingSchema = new mongoose.Schema({
  ...
  paymentStatus: {
    type: String,
    enum: ['pending_payment', 'paid', 'failed', 'refunded', 'charge_failed'],
  ...
  staircases: { type: Number, min: 0 },
  frontEntrance: { type: Boolean, default: false },
  backEntrance: { type: Boolean, default: false },

...
export default function ProfilePage() {
  ...
  return (
    <AuthGuard>
      <div className={`min-h-screen pb-24 ${dark ? 'bg-gray-900 text-white' : 'bg-gray-50'}`}>
        <header className={`px-6 pb-6 pt-12 ${dark ? 'border-b border-gray-800 bg-gray-900' : 'bg-white shadow-sm'}`}>
          {dark && (
